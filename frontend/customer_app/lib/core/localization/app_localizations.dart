...
class AppLocalizations {
  ...
  static Map<String, Map<String, String>> get _localizedValues => {
    'en': {
      ...
      'minimum_order_not_reached': 'Minimum order amount has not been reached.',
      ...
      'orders_intro_message':
          'Track your latest deliveries instantly and manage all your previous orders.',
      'orders_load_error': 'Unable to load orders right now.',
      ...
      'order_status_pending': 'Awaiting partner confirmation',
      'order_status_confirmed': 'Order accepted',
      'order_status_preparing': 'Preparing your order',
      'order_status_ready_for_pickup': 'Courier assignment in progress',
      'order_status_picked_up': 'Picked up by courier',
      'order_status_in_delivery': 'Out for delivery',
      'order_status_delivered': 'Delivered',
      'order_status_cancelled': 'Cancelled',
      'order_status_unknown': 'Unknown status',
      'order_tracking_invalid_order_id': 'Invalid order id.',
      'order_tracking_load_error': 'Unable to load order tracking right now.',
      'order_tracking_estimated_delivery': 'Estimated delivery',
      'order_tracking_preparation_time': 'Preparation time',
      'order_tracking_preparation_slot': 'Preparation slot',
      'order_tracking_preparation_slot_pending':
          'Waiting for partner assignment',
      'order_tracking_preparation_countdown': 'Prep countdown',
      'order_tracking_remaining_suffix': 'remaining',
      'order_tracking_starts_in_suffix': 'until prep starts',
      'order_tracking_preparation_done': 'Preparation completed',
      'order_tracking_partner_selected_prefix': 'partner selected',
      'order_tracking_live_process': 'Live process',
      'order_tracking_step_order_placed': 'Order placed',
      'order_tracking_step_order_placed_desc':
          'We have received your order successfully.',
      'order_tracking_step_partner_confirmation': 'Partner confirmation',
      'order_tracking_step_partner_confirmation_desc':
          'Waiting for confirmation.',
      'order_tracking_step_preparation': 'Preparation',
      'order_tracking_estimated_prep_time': 'Estimated prep time',
      'order_tracking_step_out_for_delivery': 'Out for delivery',
      'order_tracking_step_out_for_delivery_desc':
          'Courier is heading to your address.',
      'order_tracking_step_delivered': 'Delivered',
      'order_tracking_step_delivered_desc': 'Enjoy your meal.',
      'order_confirmation_eta_soon': 'Soon',
      'order_confirmation_success_title': 'Order Confirmed',
      'order_confirmation_success_message':
          'Your order has been placed successfully.',
      'order_confirmation_success_suffix': 'has been placed.',
      'order_confirmation_estimated_delivery': 'Estimated delivery',
      'order_confirmation_opening_tracking_in': 'Opening tracking in',
      'continue_shopping': 'Continue shopping',
      'cardholder_placeholder': 'CARD HOLDER',
      'pay_action': 'Pay',
      'reviews': 'Reviews',
      ...
      'product_detail_hours_abbr': 'h',
      'product_detail_days_abbr': 'd',
    ...
    'fr': {
      ...
      'orders_intro_message':
          'Suivez vos dernieres livraisons instantanement et gerez toutes vos commandes precedentes.',
      'orders_load_error':
          'Impossible de charger les commandes pour le moment.',
      'partner_unavailable': 'Partenaire indisponible',
      'products_count_suffix': 'produits',
      'unknown_date': 'Date inconnue',
      'go_to_my_orders': 'Aller a mes commandes',
      'order_tracking_title': 'Suivi de commande',
      'order_status_pending': 'En attente de confirmation',
      'order_status_confirmed': 'Commande acceptee',
      'order_status_preparing': 'Preparation de votre commande',
      'order_status_ready_for_pickup': 'Attribution du livreur en cours',
      'order_status_picked_up': 'Recuperee par le livreur',
      'order_status_in_delivery': 'En cours de livraison',
      'order_status_delivered': 'Livree',
      'order_status_cancelled': 'Annulee',
      'order_status_unknown': 'Statut inconnu',
      'order_tracking_invalid_order_id': 'Identifiant de commande invalide.',
      'order_tracking_load_error':
          'Impossible de charger le suivi de commande pour le moment.',
      'order_tracking_estimated_delivery': 'Livraison estimee',
      'order_tracking_preparation_time': 'Temps de preparation',
      'order_tracking_preparation_slot': 'Creneau de preparation',
      'order_tracking_preparation_slot_pending':
          'En attente d attribution du partenaire',
      'order_tracking_preparation_countdown': 'Decompte de preparation',
      'order_tracking_remaining_suffix': 'restantes',
      'order_tracking_starts_in_suffix': 'avant debut preparation',
      'order_tracking_preparation_done': 'Preparation terminee',
      'order_tracking_partner_selected_prefix': 'choisi par le partenaire',
      'order_tracking_live_process': 'Processus en direct',
      'order_tracking_step_order_placed': 'Commande passee',
      'order_tracking_step_order_placed_desc':
          'Nous avons bien recu votre commande.',
      'order_tracking_step_partner_confirmation': 'Confirmation du partenaire',
      'order_tracking_step_partner_confirmation_desc':
          'En attente de confirmation du restaurant.',
      'order_tracking_step_preparation': 'Preparation',
      'order_tracking_estimated_prep_time': 'Temps de preparation estime',
      'order_tracking_step_out_for_delivery': 'En cours de livraison',
      'order_tracking_step_out_for_delivery_desc':
          'Le livreur se dirige vers votre adresse.',
      'order_tracking_step_delivered': 'Livree',
      'order_tracking_step_delivered_desc': 'Bon appetit.',
      'order_confirmation_eta_soon': 'Bientot',
      'order_confirmation_success_title': 'Commande confirmee',
      'order_confirmation_success_message':
          'Votre commande a ete validee avec succes.',
      'order_confirmation_success_suffix': 'a ete validee.',
      'order_confirmation_estimated_delivery': 'Livraison estimee',
      'order_confirmation_opening_tracking_in': 'Ouverture du suivi dans',
      'continue_shopping': 'Continuer les achats',
      'cardholder_placeholder': 'TITULAIRE',
      'pay_action': 'Payer',
      'reviews': 'Avis',
    ...
    'ar': {
      ...
      'orders_intro_message':
          'تابع آخر عمليات التوصيل فوراً وادِر جميع طلباتك السابقة.',
      'orders_load_error': 'تعذر تحميل الطلبات حالياً.',
      'partner_unavailable': 'الشريك غير متاح',
      'products_count_suffix': 'منتجات',
      'unknown_date': 'تاريخ غير معروف',
      'go_to_my_orders': 'الذهاب إلى طلباتي',
      'order_tracking_title': 'تتبع الطلب',
      'order_status_pending': 'بانتظار تأكيد الشريك',
      'order_status_confirmed': 'تم قبول الطلب',
      'order_status_preparing': 'جارٍ تحضير طلبك',
      'order_status_ready_for_pickup': 'جارٍ تعيين المندوب',
      'order_status_picked_up': 'تم استلامه من المندوب',
      'order_status_in_delivery': 'قيد التوصيل',
      'order_status_delivered': 'تم التسليم',
      'order_status_cancelled': 'تم الإلغاء',
      'order_status_unknown': 'حالة غير معروفة',
      'order_tracking_invalid_order_id': 'معرف الطلب غير صالح.',
      'order_tracking_load_error': 'تعذر تحميل تتبع الطلب حالياً.',
      'order_tracking_estimated_delivery': 'وقت التوصيل المتوقع',
      'order_tracking_preparation_time': 'وقت التحضير',
      'order_tracking_preparation_slot': 'فترة التحضير',
      'order_tracking_preparation_slot_pending':
          'بانتظار تحديد الفترة من الشريك',
      'order_tracking_preparation_countdown': 'العد التنازلي للتحضير',
      'order_tracking_remaining_suffix': 'متبقية',
      'order_tracking_starts_in_suffix': 'حتى بدء التحضير',
      'order_tracking_preparation_done': 'اكتمل التحضير',
      'order_tracking_partner_selected_prefix': 'اختاره الشريك',
      'order_tracking_live_process': 'الحالة المباشرة',
      'order_tracking_step_order_placed': 'تم تقديم الطلب',
      'order_tracking_step_order_placed_desc': 'لقد استلمنا طلبك بنجاح.',
      'order_tracking_step_partner_confirmation': 'تأكيد الشريك',
      'order_tracking_step_partner_confirmation_desc': 'بانتظار تأكيد المطعم.',
      'order_tracking_step_preparation': 'التحضير',
      'order_tracking_estimated_prep_time': 'وقت التحضير المتوقع',
      'order_tracking_step_out_for_delivery': 'قيد التوصيل',
      'order_tracking_step_out_for_delivery_desc':
          'المندوب في الطريق إلى عنوانك.',
      'order_tracking_step_delivered': 'تم التسليم',
      'order_tracking_step_delivered_desc': 'نتمنى لك وجبة شهية.',
      'order_confirmation_eta_soon': 'قريباً',
      'order_confirmation_success_title': 'تم تأكيد الطلب',
      'order_confirmation_success_message': 'تم تقديم طلبك بنجاح.',
      'order_confirmation_success_suffix': 'تم تأكيده.',
      'order_confirmation_estimated_delivery': 'التوصيل المتوقع',
      'order_confirmation_opening_tracking_in': 'سيتم فتح التتبع خلال',
      'continue_shopping': 'متابعة التسوق',
      'cardholder_placeholder': 'اسم حامل البطاقة',
      'pay_action': 'ادفع',
      'reviews': 'التقييمات',
      ...
      'product_detail_hours_abbr': 'س',
      'product_detail_days_abbr': 'ي',
